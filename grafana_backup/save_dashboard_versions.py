...
def main(args, settings):
    ...
    folder_path = "{0}/dashboard_versions/{1}".format(
...
def get_versions_and_save(
    ...
    for board in dashboards:
        ...
        board_folder_path = os.path.join(
            folder_path,
            board["uid"],
        )
...
def get_individual_versions(
    ...
    with open(file_path, "w") as f:
        ...
        for version in versions:
            ...
            dashboard_id = version.get("dashboardId")
            version_no = version.get("version")

            if dashboard_id is None or version_no is None:
                continue
